...
- print.py: simple test of the print function
- input.py: simple test of the input function
- binops.py: test of intricate arithmetic operations, and some dead code.
...
- while.py: test a simple while loop (fails)
